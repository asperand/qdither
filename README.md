...
The custom palette file uses hexcode formatting for colors, and has a decent ability to filter out junk. Your best bet is to provide it with a text file of one hexcode color per line, similar to how https://lospec.com/palette-list provides their `.HEX` palette downloads.
