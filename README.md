A combination of two separate projects, this is a command-line tool that takes in an image and reduces it's colors. It uses Macroquad for visualizing the progress of the dither to a window.
